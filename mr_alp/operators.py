...
def op_x7_tc_repair(
    ...
    Selects the highest-impact aircraft (by LP impact or TC/load score) and
    attempts X3 transfer to another runway; falls back to N3b re-insertion.
    """
    m = len(seqs)
    cands = (
        [(impact[seqs[rho][pos]], rho, pos)
